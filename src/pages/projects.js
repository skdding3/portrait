...
import FeatureProjectImg3 from "../../public/images/projects/oss.png";
...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    <article className="w-full flex items-center justify-between rounded-3xl rounded-br-2xl border border-solid border-dark bg-light shadow-2xl relative dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4">
      <div className="absolute top-0 -right-3 -z-10 w-[100%] h-[103%] rounded-[3rem] bg-dark rounded-br-3xl dark:bg-light xs:-right-2 sm:h-[102%] xs:w-full xs:rounded-[1.5rem]" />
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
        ...
        <h2 className="my-2 w-full text-left text-xl text-bold dark:text-light sm:text-sm">
          {title}
        </h2>
  ...
  return (
    <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light xs:p-4">
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        ...
        <h2 className="my-2 w-full text-left text-xl text-bold dark:text-light lg:text-2xl">
          {title}
        </h2>
        ...
        <div className="w-full mt-2 flex items-center justify-between">
          <Link
            href={link}
            target="_blank"
            className="text-lg underline font-semibold dark:text-light md:text-base"
          >
            {" "}
            프로젝트 개요{" "}
          </Link>
        ...
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                title="1.0 -> 2.0 마이그레이션 작업"
                link="https://www.notion.so/skdding/1683bd86d41881ba9b32e946db9f39ca?pvs=4"
                summary="한국전력 및 해상풍력에 운용중인 변전소에 이상치 감지를 통해 변전소에 작동에 안전성을 기여하는 종합예방진단 시스템에 프로덕트 연구개발입니다.
                              이를 1.0 -> 2.0으로 마이그레이션 작업을 진행하였습니다."
                github="/"
                type="예방진단 통합운영시스템"
                img={FeatureProjectImg3}
              />
            </div>
            <div className="col-span-12">
              <FeaturedProject
                ...
                summary="웰에이징 회원 관리 시스템 실서비스 개발을 진행하였습니다.
                            ...
                            이후 과정을 수료하는 시스템입니다."
                link="https://www.notion.so/skdding/1683bd86d41881faadadd4acf7a7ed6e?pvs=4"
                github="/"
