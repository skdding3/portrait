                ...
                <Layout className="pt-16">
                    ...
                    <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
                        ...
                        <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
                            ...
                            <h2 className="my-4 mb-4 text-lg font-bold uppercase text-dark/75 dark:text-light/75">시각적인 감각을 가진 프론트엔드</h2>
                            <p className="font-normal text-sm/[15px]">
                            ...
                            <h2 className="my-4 mb-4 text-lg font-bold uppercase text-dark/75 dark:text-light/75">소통을 즐기고 참여하길 원합니다.</h2>
                            <p className="font-normal text-sm/[15px]">
                        ...
                        {/* Profile Picture */}
                        <div
                            className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 md:order-1 md:col-span-8">
