        ...
        <>
            ...
            <main className="flex w-full flex-col items-center justify-center">
                <Layout className="pt-16">
                    <AnimatedText className="text-6xl mb-16" text="시각적인 감각을 가진 프론트엔드 개발자입니다!"/>
                    <div className="grid w-full grid-cols-8 gap-16">
                        ...
                        <div className="col-span-3 flex flex-col items-start justify-start">
                            ...
                            <p className="font-normal text-sm/[15px]">
                                ...
                                현업에서 실제로 사용하는 문법이나 방법들을 공부하며, 익힌 새로운 지식들은 항상 기술 블로그인 Github나 Notion 그리고 Velog에 작성하며 꾸준하게
                                쌓아가고 있습니다.
                            </p>
                            ...
                            <p className="font-normal text-sm/[15px]">
                                ...
                                느꼈던 감각을 통해 **Front-End 분야 독학 공부**로 과감히 전환하여, 다시 공부를 시작하였고 컴포넌트를 구상하는 부분에서나 상상하던 디자인을 직접
                                ...
                                기반으로 템플릿 부분과 Static 부분에 View 작업을 진행하였고, 이외에도 **React를** 활용하여 페이지를 구축하는 공부와 NextJS를 기반으로
                                한 구축에 대해 계속 배워나가고 있습니다. 또한 컴퓨터 공학사 과정 (학점은행제)를 함께 병행하여 **개발 프로세스에서 필요한 CS지식**들 (네트워크,
                            ...
                            <p className="font-normal text-sm/[15px]">
                                개발직군에서 이론적인 이해와 코딩 적용 그리고 도메인지식에 대한 이해 등 중요한 부분이 많지만 가장 중요하다 생각되는 부분은 협업하는 과정에서 이루어지는
                                **커뮤니케이션** 이라고 생각합니다. <br/><br/>

                                특히 **Front-End 개발자**는 UI,UX 디자이너나 백엔드 개발자의 각기 다른 이해를 중간에서 엮어주는 역할이 필요하다고 보고 있습니다. 개발 공부를
