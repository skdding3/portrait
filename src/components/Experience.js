    ...
    <div className="my-64">
      ...
      <div ref={ref} className="w-[60%] relative lg:w-[90%] md:w-full">
        ...
        <ul className="xs:ml-2">
          <Details
            position="AI BootCamp"
            company="Code States"
            time="2021.05-2021.11"
            address="Seoul"
            work="AI 부트캠프 4기를 수료하였습니다."
          />
          ...
          <Details
            ...
            address="Seoul"
            work="솔루션 개발팀에서 프론트엔드 개발을 진행하였습니다."
          />
          <Details
            position="Front-End Engineer"
            company="Nexchal"
            time="2023.07-"
            address="Seoul"
            work="연구개발팀에서 프론트엔드 개발을 진행하였습니다."
          />
        </ul>
      </div>
      <h3 className="font-bold text-3xl mb-16 w-full text-center">
        PhotoGrapher
      </h3>
      <div ref={ref} className="w-[60%] relative lg:w-[90%] md:w-full">
        ...
        <ul>
          <Details
            position="PhotoFreelancer"
            company="Freelancer"
            time="2012-2020"
            address="Korea,Japan"
            work="MUSINSA, DreamRecord 외 다수"
          />
          <Details
            position="PhotoGrapher"
            company="Man's Nonno"
            time="2017.05-2018.10"
            address="Japan"
            work="스트릿 패션 잡지 사진 작업"
          />
          <Details
            position="PhotoGrapher and Design"
            company="OMNIVERSE"
            time="2019.12-2021.03"
            address="Paju"
            work="CARIN ,Stonehenge ,Rosemont ,모나코어나더"
          />
        </ul>
      </div>
    </div>
